        ...
        <HomeLayout>
            <div className="flex flex-col text-center justify-center bg-white">
                ...
                <div className="mt-10 grid lg:grid-cols-3 md:grid-cols-2 gap-6 lg:gap-[2.4%] md:gap-5 lg:pt-[6em] lg:px-[9em] md:px-[2em] px-[1em]">
                    ...
                    <button className="font-bold text-[0.9em] text-[#7B61FF] border-2 transition-all duration-300 border-[#7B61FF] hover:bg-[#7B61FF] hover:text-white rounded-md mt-auto p-2">
                        Choose this plan
                    </button>
                    </div>
                    ...
                    <button className="font-bold text-[0.9em] text-[#7B61FF] border-2 transition-all duration-300 border-[#7B61FF] hover:bg-[#7B61FF] hover:text-white rounded-md mt-5 lg:mt-auto p-2">
                        Contact us
                    </button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-1 items-center z-[2] relative text-white">
                    ...
                    <button className="bg-white border-none py-3 p-6 md:px-12 rounded-lg font-bold text-[#6651D4] text-sm mt-5">
                    Contact Us
                    </button>
                </div>
                </div>
                ...
                <button className="bg-[#7B61FF] font-bold border-none py-3 p-6 md:px-10 rounded-lg text-white text-sm mt-5">
                    Get Started
                </button>
                </div>
            </div>
